...
void loop() {
    if (digitalRead(BUTTON_A) == LOW) { sendButtonPress("A"); delay(500); }
    if (digitalRead(BUTTON_B) == LOW) { sendButtonPress("B"); delay(500); }
    if (digitalRead(BUTTON_C) == LOW) { sendButtonPress("C"); delay(500); }
    if (digitalRead(BUTTON_D) == LOW) { sendButtonPress("D"); delay(500); }
}
